...
function Banner() {
  ...
  return (
    ...
    style={{
        backgroundImage:movie?.backdrop_path ? `url(https://image.tmdb.org/t/p/original${movie?.backdrop_path})` :"url(''https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-rGFlY8UQDdskCZW3D6WGmPAIQlKf0id6da3f6jZbqrSTwARHwsEj2RXyCr5h8I3TiKA&usqp=CAU'')",
